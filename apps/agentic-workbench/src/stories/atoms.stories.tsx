    ...
    <div className="grid max-w-xl gap-5">
      <div className="grid gap-2">
        ...
        <div className="w-72 rounded-md border bg-background px-3 py-2">
          <EllipsisPopoverText
            value="/Users/yoophi/project/worktrees/agentic-workbench/feature/ellipsis-popover-text"
      ...
      <div className="grid gap-2">
        ...
        <div className="w-80 rounded-md border bg-background px-3 py-2">
          <EllipsisPopoverText
            value="git@github.com:yoophi/agentic-workbench-with-a-very-long-repository-name.git"
            className="font-mono text-xs text-muted-foreground"
            contentClassName="font-mono text-xs"
          />
        </div>
