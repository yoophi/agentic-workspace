...
export const sampleWorktreeFiles: WorktreeFileEntry[] = [
  ...
  {
    name: "src",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/src",
    relativePath: "src",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  ...
  {
    name: "specs",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs",
    relativePath: "specs",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  ...
  {
    name: "app.ts",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/docs/app.ts",
    relativePath: "docs/app.ts",
    isDir: false,
    size: 38,
    modifiedMs: 1760000000000,
  },
  ...
  {
    name: "한글 파일.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/docs/한글 파일.md",
    relativePath: "docs/한글 파일.md",
    isDir: false,
    size: 62,
    modifiedMs: 1760000000000,
  },
  {
    name: "app.ts",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/src/app.ts",
  ...
  {
    name: "deep",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/src/deep",
    relativePath: "src/deep",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  },
  {
    name: "inner.ts",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/src/deep/inner.ts",
    relativePath: "src/deep/inner.ts",
    isDir: false,
    size: 56,
    modifiedMs: 1760000000000,
  },
  {
    name: "021-speckit-files-panel",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel",
    relativePath: "specs/021-speckit-files-panel",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  },
  {
    name: "spec.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/spec.md",
    relativePath: "specs/021-speckit-files-panel/spec.md",
    isDir: false,
    size: 18_400,
    modifiedMs: 1_783_510_000_000,
  },
  {
    name: "plan.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/plan.md",
    relativePath: "specs/021-speckit-files-panel/plan.md",
    isDir: false,
    size: 8_500,
    modifiedMs: 1_783_510_100_000,
  },
  {
    name: "tasks.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/tasks.md",
    relativePath: "specs/021-speckit-files-panel/tasks.md",
    isDir: false,
    size: 14_200,
    modifiedMs: 1_783_510_200_000,
  },
  {
    name: "contracts",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/contracts",
    relativePath: "specs/021-speckit-files-panel/contracts",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  },
  {
    name: "speckit-panel-ui.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/contracts/speckit-panel-ui.md",
    relativePath: "specs/021-speckit-files-panel/contracts/speckit-panel-ui.md",
    isDir: false,
    size: 4_700,
    modifiedMs: 1_783_510_300_000,
  },
  {
    name: "checklists",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/checklists",
    relativePath: "specs/021-speckit-files-panel/checklists",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  },
  {
    ...
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/checklists/requirements.md",
    relativePath: "specs/021-speckit-files-panel/checklists/requirements.md",
    isDir: false,
    size: 1_600,
    modifiedMs: 1_783_510_400_000,
  },
  {
    name: "022-very-long-feature-name-for-layout-validation-and-scanning",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/022-very-long-feature-name-for-layout-validation-and-scanning",
    relativePath: "specs/022-very-long-feature-name-for-layout-validation-and-scanning",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  },
  {
    name: "spec.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md",
    relativePath: "specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md",
    isDir: false,
    size: 9_200,
    modifiedMs: 1_783_510_500_000,
  },
  {
    name: "023-no-tasks-file",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/023-no-tasks-file",
    relativePath: "specs/023-no-tasks-file",
    isDir: true,
    size: 0,
    modifiedMs: 1760000000000,
  },
  {
    name: "spec.md",
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/023-no-tasks-file/spec.md",
    relativePath: "specs/023-no-tasks-file/spec.md",
    isDir: false,
    size: 4_200,
    modifiedMs: 1_783_510_600_000,
  },
];
...
export const sampleWorktreeTextFiles: Record<string, WorktreeTextFile> = {
  ...
  "docs/app.ts": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/docs/app.ts",
    relativePath: "docs/app.ts",
    content: "export const source = 'docs-app';\n",
    size: 38,
    truncated: false,
  },
  "docs/한글 파일.md": {
  ...
  "src/app.ts": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/src/app.ts",
    relativePath: "src/app.ts",
    content: "export const source = 'src-app';\n",
    size: 48,
    truncated: false,
  },
  "src/deep/inner.ts": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/src/deep/inner.ts",
    relativePath: "src/deep/inner.ts",
    content: "export const nested = 'src-deep-inner';\n",
    size: 56,
    truncated: false,
  },
  ...
  "specs/021-speckit-files-panel/spec.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/spec.md",
    relativePath: "specs/021-speckit-files-panel/spec.md",
    content: "# Feature Specification: Speckit Files Panel\n\n사용자는 worktree session에서 Speckit 문서를 빠르게 탐색합니다.\n",
    size: 18_400,
    truncated: false,
  },
  "specs/021-speckit-files-panel/plan.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/plan.md",
    relativePath: "specs/021-speckit-files-panel/plan.md",
    content: "# Implementation Plan: Speckit Files Panel\n\n기존 worktree file 조회와 markdown preview 흐름을 재사용합니다.\n",
    size: 8_500,
    truncated: false,
  },
  "specs/021-speckit-files-panel/tasks.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/tasks.md",
    relativePath: "specs/021-speckit-files-panel/tasks.md",
    content: "- [x] T001 Review workspace\n- [x] T002 Create model\n- [ ] T003 Add panel\n- [ ] T004 Verify stories\n",
    size: 14_200,
    truncated: false,
  },
  "specs/021-speckit-files-panel/contracts/speckit-panel-ui.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/contracts/speckit-panel-ui.md",
    relativePath: "specs/021-speckit-files-panel/contracts/speckit-panel-ui.md",
    content: "# Contract: Speckit Files Panel\n\nSpeckit tab은 기능, 문서, task 진행 상태를 표시합니다.\n",
    size: 4_700,
    truncated: false,
  },
  "specs/021-speckit-files-panel/checklists/requirements.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/021-speckit-files-panel/checklists/requirements.md",
    relativePath: "specs/021-speckit-files-panel/checklists/requirements.md",
  ...
  "specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md",
    relativePath:
      "specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md",
    content: "# Long path fixture\n\n긴 경로 레이아웃을 검증합니다.\n",
    size: 9_200,
    truncated: false,
  },
  "specs/023-no-tasks-file/spec.md": {
    path: "/Users/yoophi/project/worktrees/agentic-workbench/storybook/specs/023-no-tasks-file/spec.md",
    relativePath: "specs/023-no-tasks-file/spec.md",
    content: "# No tasks fixture\n\n이 기능은 tasks.md가 없습니다.\n",
    size: 4_200,
    truncated: false,
  },
};
...
export const sampleSpeckitFeatures: SpeckitFeature[] = [
  {
    id: "specs/021-speckit-files-panel",
    name: "021-speckit-files-panel",
    relativePath: "specs/021-speckit-files-panel",
    status: "ready",
    taskProgress: {
      ...
      remaining: 29,
      state: "inProgress",
      sourcePath: "specs/021-speckit-files-panel/tasks.md",
    },
    documents: [
      {
        id: "specs/021-speckit-files-panel/spec.md",
        featureId: "specs/021-speckit-files-panel",
        type: "spec",
        label: "Spec",
        relativePath: "specs/021-speckit-files-panel/spec.md",
        group: "core",
      ...
      {
        id: "specs/021-speckit-files-panel/plan.md",
        featureId: "specs/021-speckit-files-panel",
        type: "plan",
        label: "Plan",
        relativePath: "specs/021-speckit-files-panel/plan.md",
      ...
      {
        id: "specs/021-speckit-files-panel/tasks.md",
        featureId: "specs/021-speckit-files-panel",
        type: "tasks",
        label: "Tasks",
        relativePath: "specs/021-speckit-files-panel/tasks.md",
      ...
      {
        id: "specs/021-speckit-files-panel/contracts/speckit-panel-ui.md",
        featureId: "specs/021-speckit-files-panel",
        type: "contract",
        label: "Contract",
        relativePath: "specs/021-speckit-files-panel/contracts/speckit-panel-ui.md",
      ...
      {
        id: "specs/021-speckit-files-panel/checklists/requirements.md",
        featureId: "specs/021-speckit-files-panel",
        type: "checklist",
        label: "Checklist",
        relativePath: "specs/021-speckit-files-panel/checklists/requirements.md",
  ...
  {
    id: "specs/022-very-long-feature-name-for-layout-validation-and-scanning",
    name: "022-very-long-feature-name-for-layout-validation-and-scanning",
    relativePath: "specs/022-very-long-feature-name-for-layout-validation-and-scanning",
    status: "ready",
    taskProgress: {
      ...
      remaining: 0,
      state: "noTasks",
      sourcePath: "specs/022-very-long-feature-name-for-layout-validation-and-scanning/tasks.md",
    },
    documents: [
      {
        id: "specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md",
        featureId: "specs/022-very-long-feature-name-for-layout-validation-and-scanning",
        type: "spec",
        label: "Spec",
        relativePath:
          "specs/022-very-long-feature-name-for-layout-validation-and-scanning/spec.md",
  ...
  },
  {
    ...
    documents: [
      {
        id: "specs/023-no-tasks-file/spec.md",
        featureId: "specs/023-no-tasks-file",
        type: "spec",
        label: "Spec",
        relativePath: "specs/023-no-tasks-file/spec.md",
        group: "core",
      ...
      {
        id: "specs/023-no-tasks-file/research.md",
        featureId: "specs/023-no-tasks-file",
        type: "research",
        label: "Research",
        relativePath: "specs/023-no-tasks-file/research.md",
        group: "core",
        size: 7_100,
        modifiedMs: 1_783_510_700_000,
        readState: "unreadable",
        errorMessage: "문서를 읽을 수 없습니다.",
      },
    ],
  },
];
